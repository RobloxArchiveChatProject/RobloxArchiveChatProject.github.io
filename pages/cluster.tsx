            ...
            <div className="flex flex-col justify-center mx-8"> {/* main container */}
                {
                    (!loading && dialogue)
                        ? <div className={"p-4 rounded-2xl " + (dialogue.pkgversion === "0.0.2" ? "neon" : "")}>
                            <h1 className={"text-3xl font-semibold " + ((loading) ? "text-red-700 font-bold" : "")}> {currentUUID} </h1>
                            ...
                            <br />
                            <div className="overflow-auto scroll flex flex-col justify-start" style={{ maxHeight: "20rem" }}>
